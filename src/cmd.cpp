...
int cmdGraphics(App* _app, void* _userData, int _argc, char const* const* _argv)
{
	...
	if (_argc > 1)
	{
		...
		||  setOrToggle(g_reset, "hmd",         BGFX_RESET_HMD,                1, _argc, _argv)
		||  setOrToggle(g_reset, "hmddbg",      BGFX_RESET_HMD_DEBUG,          1, _argc, _argv)
		||  setOrToggle(g_reset, "hmdrecenter", BGFX_RESET_HMD_RECENTER,       1, _argc, _argv)
